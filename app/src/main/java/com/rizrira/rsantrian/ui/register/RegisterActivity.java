package com.rizrira.rsantrian.ui.register;
...
import com.rizrira.rsantrian.databinding.ActivityRegisterBinding;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void formRegisterValidation() {
        ...
        if (!binding.edtPasswordRegister.getText().toString().equals(binding.edtPasswordConfirmation.getText().toString())) {
            binding.tipPasswordConfirmationRegister.setError("Password Harus Sama");
            return;
        } else {
