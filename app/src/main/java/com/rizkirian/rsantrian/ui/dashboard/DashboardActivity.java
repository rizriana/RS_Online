...
//        LinearLayout mAdViewLayout = findViewById(R.id.adView);
        ...
        cvAnggotaKeluarga.setOnClickListener(view -> {
            Intent intent1 = new Intent(DashboardActivity.this, ListAnggotaKeluarga.class);
                ...
                new AlertDialog.Builder(DashboardActivity.this)
                        ...
                        .setPositiveButton("PASIEN LAMA", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int id) {
                                Intent intent1 = new Intent(DashboardActivity.this, PilihPasienActivity.class);
                                intent1.putExtra("id_user2", tviduser.getText().toString());
                                startActivity(intent1);
                            }
                        })
                        .setNegativeButton("PASIEN BARU", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                Intent intent1 = new Intent(DashboardActivity.this, InputPasienActivity.class);
                                startActivity(intent1);
                            }
                        })
                        .show();
